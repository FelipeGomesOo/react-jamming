...
export default function SavedPlaylist({playlist, handleEdit, handleRemove, handleSave}) {
    return (
        <li className='SavedPlaylist box'> 
            ...
            <div className="SavedPlaylist__info">                
                ...
                <a className={`SavedPlaylist__save_on_spotify ${playlist.spotify ? 'saved' : 'not_saved'}`} href="#" onClick={handleSave}>Save on Spotify</a>    
            </div>        
        </li>
)}